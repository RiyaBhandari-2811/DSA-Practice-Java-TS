public class UpperBoundBS {
     ...
     *
     * Idea:
     * - Since array is sorted, apply binary search.
     * - Look for the first index where arr[mid] > x.
     *
    ...
    public static void main(String[] args) {
        ...
        System.out.println(upperBoundBrute(arr, 5));
        System.out.println(upperBoundOptimal(arr, 5));
